          ...
          <div className="flex flex-col md:flex-row gap-4 items-end md:items-center">
            ...
            {loading ? (
              <button
                ...
                className="w-full md:w-auto px-8 py-3 rounded-lg font-medium text-white shadow-sm transition-all transform active:scale-95 bg-red-600 hover:bg-red-700 hover:shadow-md"
              >
